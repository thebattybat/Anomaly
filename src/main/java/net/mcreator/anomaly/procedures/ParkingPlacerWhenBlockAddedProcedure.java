	...
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (world instanceof ServerLevel _origLevel) {
			...
			if (world != null) {
				...
				world.setBlock(new BlockPos(x + 10, y, z + 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x, y, z + 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x - 10, y, z + 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x - 10, y, z - 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x, y, z - 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x + 10, y, z - 10), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x + 10, y, z), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
				world.setBlock(new BlockPos(x - 10, y, z), AnomalyModBlocks.IMMEDIATE_PARKING_PLACER.get().defaultBlockState(), 3);
			}
			world = _worldorig;
		}
