...
public class Modelsmiler<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("anomaly", "modelsmiler"), "main");
	public final ModelPart lowerjaw;
	public final ModelPart highjaw;
