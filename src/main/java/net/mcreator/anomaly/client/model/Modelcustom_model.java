...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = leftleg.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(35, 0).addBox(-1.0F, -4.0F, -3.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 17.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition cube_r2 = leftleg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(30, 35).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 8.755F, 0.1387F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r3 = leftleg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 15).addBox(-2.0F, -6.0F, -1.0F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = rightleg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, -6.0F, -1.0F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 5.0F, 0.0F, 0.0F, 0.0F, 0.5236F));
		PartDefinition cube_r5 = rightleg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(38, 35).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 8.755F, 0.1387F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r6 = rightleg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(35, 15).addBox(-1.0F, -4.0F, -3.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 17.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(30, 30).addBox(-4.0F, -1.0F, -1.0F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 4.0F, 0.0F));
		PartDefinition cube_r7 = body.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(43, 0).addBox(-2.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(43, 15).addBox(-0.5F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = body.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(16, 30).addBox(-2.0F, -18.0F, -1.0F, 4.0F, 18.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = head.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 15).addBox(-6.0F, -2.0F, -5.5F, 12.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = leftarm.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(8, 30).addBox(14.0F, -37.0F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = rightarm.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 30).addBox(1.0F, -17.5F, -1.0F, 2.0F, 35.0F, 2.0F, new CubeDeformation(0.0F)),
